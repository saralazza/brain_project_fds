...
from GAN.gan import train_loop_gan, generate_images
...
if __name__ == '__main__':
    ...
    save_dir = '../gan_dataset/yes/' 
    os.makedirs(save_dir, exist_ok=True)
    save_dir = f"{save_dir}yes_"
    generate_images(G_yes, device, save_dir)
    ...
    save_dir = '../gan_dataset/no/' 
    os.makedirs(save_dir, exist_ok=True)
    save_dir = f"{save_dir}no_"
    generate_images(G_no, device, save_dir)
